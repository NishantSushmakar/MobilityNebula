...
/**
 * @brief MEOS ecovers_tgeo_geo logical function
 * 
 * This function implements the ecovers_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EcoversTgeoGeoLogicalFunction
     */
    EcoversTgeoGeoLogicalFunction(
