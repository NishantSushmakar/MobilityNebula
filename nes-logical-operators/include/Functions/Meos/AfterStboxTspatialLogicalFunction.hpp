...
/**
 * @brief MEOS after_stbox_tspatial logical function
 * 
 * This function implements the after_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AfterStboxTspatialLogicalFunction
     */
    AfterStboxTspatialLogicalFunction(
