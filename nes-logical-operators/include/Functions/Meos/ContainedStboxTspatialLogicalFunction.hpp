...
/**
 * @brief MEOS contained_stbox_tspatial logical function
 * 
 * This function implements the contained_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for ContainedStboxTspatialLogicalFunction
     */
    ContainedStboxTspatialLogicalFunction(
