...
/**
 * @brief MEOS overback_tspatial_stbox logical function
 * 
 * This function implements the overback_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbackTspatialStboxLogicalFunction
     */
