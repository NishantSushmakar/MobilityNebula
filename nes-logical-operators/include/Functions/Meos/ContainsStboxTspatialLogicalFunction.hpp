...
/**
 * @brief MEOS contains_stbox_tspatial logical function
 * 
 * This function implements the contains_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for ContainsStboxTspatialLogicalFunction
     */
