...
/**
 * @brief MEOS contains_tspatial_tspatial logical function
 * 
 * This function implements the contains_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for ContainsTspatialTspatialLogicalFunction
     */
