...
/**
 * @brief MEOS front_stbox_tspatial logical function
 * 
 * This function implements the front_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for FrontStboxTspatialLogicalFunction
     */
