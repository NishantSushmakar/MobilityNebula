...
/**
 * @brief MEOS ever_ne_tgeo_geo logical function
 * 
 * This function implements the ever_ne_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EverNeTgeoGeoLogicalFunction
     */
