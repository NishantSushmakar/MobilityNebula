...
/**
 * @brief MEOS atouches_tgeo_tgeo logical function
 * 
 * This function implements the atouches_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AtouchesTgeoTgeoLogicalFunction
     */
