...
/**
 * @brief MEOS acontains_tgeo_tgeo logical function
 * 
 * This function implements the acontains_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AcontainsTgeoTgeoLogicalFunction
     */
    AcontainsTgeoTgeoLogicalFunction(
