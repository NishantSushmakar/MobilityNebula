...
/**
 * @brief MEOS overbelow_tspatial_tspatial logical function
 * 
 * This function implements the overbelow_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbelowTspatialTspatialLogicalFunction
     */
    OverbelowTspatialTspatialLogicalFunction(
