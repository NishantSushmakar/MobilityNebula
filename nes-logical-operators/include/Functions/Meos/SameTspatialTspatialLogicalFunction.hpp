...
/**
 * @brief MEOS same_tspatial_tspatial logical function
 * 
 * This function implements the same_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for SameTspatialTspatialLogicalFunction
     */
