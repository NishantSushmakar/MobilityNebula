...
/**
 * @brief MEOS left_tspatial_tspatial logical function
 * 
 * This function implements the left_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for LeftTspatialTspatialLogicalFunction
     */
