...
/**
 * @brief MEOS left_stbox_tspatial logical function
 * 
 * This function implements the left_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for LeftStboxTspatialLogicalFunction
     */
    LeftStboxTspatialLogicalFunction(
