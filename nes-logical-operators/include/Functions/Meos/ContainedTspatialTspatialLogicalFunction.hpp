...
/**
 * @brief MEOS contained_tspatial_tspatial logical function
 * 
 * This function implements the contained_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for ContainedTspatialTspatialLogicalFunction
     */
