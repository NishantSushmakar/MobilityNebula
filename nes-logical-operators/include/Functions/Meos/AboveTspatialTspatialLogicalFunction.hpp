...
/**
 * @brief MEOS above_tspatial_tspatial logical function
 * 
 * This function implements the above_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AboveTspatialTspatialLogicalFunction
     */
    AboveTspatialTspatialLogicalFunction(
