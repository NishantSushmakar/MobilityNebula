...
/**
 * @brief MEOS always_eq_tgeo_geo logical function
 * 
 * This function implements the always_eq_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AlwaysEqTgeoGeoLogicalFunction
     */
