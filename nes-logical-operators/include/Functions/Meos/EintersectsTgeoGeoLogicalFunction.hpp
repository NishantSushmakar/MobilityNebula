...
/**
 * @brief MEOS eintersects_tgeo_geo logical function
 * 
 * This function implements the eintersects_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EintersectsTgeoGeoLogicalFunction
     */
