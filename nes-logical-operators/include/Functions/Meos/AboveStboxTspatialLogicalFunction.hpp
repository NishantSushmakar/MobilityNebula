...
/**
 * @brief MEOS above_stbox_tspatial logical function
 * 
 * This function implements the above_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AboveStboxTspatialLogicalFunction
     */
    AboveStboxTspatialLogicalFunction(
