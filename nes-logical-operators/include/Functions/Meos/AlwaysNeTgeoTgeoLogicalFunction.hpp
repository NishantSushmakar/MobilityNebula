...
/**
 * @brief MEOS always_ne_tgeo_tgeo logical function
 * 
 * This function implements the always_ne_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AlwaysNeTgeoTgeoLogicalFunction
     */
    AlwaysNeTgeoTgeoLogicalFunction(
