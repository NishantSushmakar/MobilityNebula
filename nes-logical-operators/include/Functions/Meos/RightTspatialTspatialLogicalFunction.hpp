...
/**
 * @brief MEOS right_tspatial_tspatial logical function
 * 
 * This function implements the right_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for RightTspatialTspatialLogicalFunction
     */
    RightTspatialTspatialLogicalFunction(
