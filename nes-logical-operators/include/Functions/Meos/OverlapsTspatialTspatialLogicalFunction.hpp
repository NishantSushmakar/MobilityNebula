...
/**
 * @brief MEOS overlaps_tspatial_tspatial logical function
 * 
 * This function implements the overlaps_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverlapsTspatialTspatialLogicalFunction
     */
