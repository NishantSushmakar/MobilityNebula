...
/**
 * @brief MEOS overabove_tspatial_tspatial logical function
 * 
 * This function implements the overabove_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OveraboveTspatialTspatialLogicalFunction
     */
    OveraboveTspatialTspatialLogicalFunction(
