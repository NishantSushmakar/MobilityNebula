...
/**
 * @brief MEOS overbefore_tspatial_tspatial logical function
 * 
 * This function implements the overbefore_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbeforeTspatialTspatialLogicalFunction
     */
    OverbeforeTspatialTspatialLogicalFunction(
