...
/**
 * @brief MEOS overbefore_stbox_tspatial logical function
 * 
 * This function implements the overbefore_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbeforeStboxTspatialLogicalFunction
     */
