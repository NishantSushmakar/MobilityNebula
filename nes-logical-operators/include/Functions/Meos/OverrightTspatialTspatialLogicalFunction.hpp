...
/**
 * @brief MEOS overright_tspatial_tspatial logical function
 * 
 * This function implements the overright_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverrightTspatialTspatialLogicalFunction
     */
