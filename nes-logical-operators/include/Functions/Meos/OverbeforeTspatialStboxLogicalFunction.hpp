...
/**
 * @brief MEOS overbefore_tspatial_stbox logical function
 * 
 * This function implements the overbefore_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbeforeTspatialStboxLogicalFunction
     */
