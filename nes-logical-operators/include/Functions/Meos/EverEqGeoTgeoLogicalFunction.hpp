...
/**
 * @brief MEOS ever_eq_geo_tgeo logical function
 * 
 * This function implements the ever_eq_geo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EverEqGeoTgeoLogicalFunction
     */
    EverEqGeoTgeoLogicalFunction(
