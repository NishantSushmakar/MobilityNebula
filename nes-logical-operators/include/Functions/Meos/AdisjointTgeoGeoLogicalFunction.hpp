...
/**
 * @brief MEOS adisjoint_tgeo_geo logical function
 * 
 * This function implements the adisjoint_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AdisjointTgeoGeoLogicalFunction
     */
    AdisjointTgeoGeoLogicalFunction(
