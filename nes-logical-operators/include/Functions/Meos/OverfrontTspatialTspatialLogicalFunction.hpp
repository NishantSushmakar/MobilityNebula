...
/**
 * @brief MEOS overfront_tspatial_tspatial logical function
 * 
 * This function implements the overfront_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverfrontTspatialTspatialLogicalFunction
     */
