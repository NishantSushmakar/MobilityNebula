...
/**
 * @brief MEOS atouches_tpoint_geo logical function
 * 
 * This function implements the atouches_tpoint_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AtouchesTpointGeoLogicalFunction
     */
    AtouchesTpointGeoLogicalFunction(
