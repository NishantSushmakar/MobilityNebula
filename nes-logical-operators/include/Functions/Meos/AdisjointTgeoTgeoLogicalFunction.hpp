...
/**
 * @brief MEOS adisjoint_tgeo_tgeo logical function
 * 
 * This function implements the adisjoint_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AdisjointTgeoTgeoLogicalFunction
     */
    AdisjointTgeoTgeoLogicalFunction(
