...
/**
 * @brief MEOS back_tspatial_stbox logical function
 * 
 * This function implements the back_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BackTspatialStboxLogicalFunction
     */
    BackTspatialStboxLogicalFunction(
