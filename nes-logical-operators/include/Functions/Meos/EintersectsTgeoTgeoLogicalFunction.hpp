...
/**
 * @brief MEOS eintersects_tgeo_tgeo logical function
 * 
 * This function implements the eintersects_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EintersectsTgeoTgeoLogicalFunction
     */
