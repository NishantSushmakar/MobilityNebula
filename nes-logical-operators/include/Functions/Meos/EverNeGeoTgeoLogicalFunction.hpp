...
/**
 * @brief MEOS ever_ne_geo_tgeo logical function
 * 
 * This function implements the ever_ne_geo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EverNeGeoTgeoLogicalFunction
     */
    EverNeGeoTgeoLogicalFunction(
