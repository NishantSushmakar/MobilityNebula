...
/**
 * @brief MEOS overabove_tspatial_stbox logical function
 * 
 * This function implements the overabove_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OveraboveTspatialStboxLogicalFunction
     */
    OveraboveTspatialStboxLogicalFunction(
