...
/**
 * @brief MEOS overbelow_stbox_tspatial logical function
 * 
 * This function implements the overbelow_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbelowStboxTspatialLogicalFunction
     */
    OverbelowStboxTspatialLogicalFunction(
