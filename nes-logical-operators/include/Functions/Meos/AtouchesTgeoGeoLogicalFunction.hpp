...
/**
 * @brief MEOS atouches_tgeo_geo logical function
 * 
 * This function implements the atouches_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AtouchesTgeoGeoLogicalFunction
     */
