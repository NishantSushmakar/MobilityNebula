...
/**
 * @brief MEOS acontains_geo_tgeo logical function
 * 
 * This function implements the acontains_geo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AcontainsGeoTgeoLogicalFunction
     */
    AcontainsGeoTgeoLogicalFunction(
