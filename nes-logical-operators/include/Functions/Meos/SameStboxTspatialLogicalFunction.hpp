...
/**
 * @brief MEOS same_stbox_tspatial logical function
 * 
 * This function implements the same_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for SameStboxTspatialLogicalFunction
     */
    SameStboxTspatialLogicalFunction(
