...
/**
 * @brief MEOS econtains_geo_tgeo logical function
 * 
 * This function implements the econtains_geo_tgeo operation from MEOS library.
 * Function signature: extern int econtains_geo_tgeo(const GSERIALIZED *gs, const Temporal *temp);
 */
class EcontainsGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcontainsGeoTgeo";

    /**
     * @brief Constructor for EcontainsGeoTgeoLogicalFunction
     */
    EcontainsGeoTgeoLogicalFunction(
