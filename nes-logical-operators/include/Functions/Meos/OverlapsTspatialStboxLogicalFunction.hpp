...
/**
 * @brief MEOS overlaps_tspatial_stbox logical function
 * 
 * This function implements the overlaps_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverlapsTspatialStboxLogicalFunction
     */
