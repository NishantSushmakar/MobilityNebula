...
/**
 * @brief MEOS ever_eq_tgeo_geo logical function
 * 
 * This function implements the ever_eq_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EverEqTgeoGeoLogicalFunction
     */
    EverEqTgeoGeoLogicalFunction(
