...
/**
 * @brief MEOS right_stbox_tspatial logical function
 * 
 * This function implements the right_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for RightStboxTspatialLogicalFunction
     */
