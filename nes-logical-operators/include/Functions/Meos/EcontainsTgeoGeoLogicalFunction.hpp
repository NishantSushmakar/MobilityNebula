...
/**
 * @brief MEOS econtains_tgeo_geo logical function
 * 
 * This function implements the econtains_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EcontainsTgeoGeoLogicalFunction
     */
