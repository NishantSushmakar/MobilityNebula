...
/**
 * @brief MEOS above_tspatial_stbox logical function
 * 
 * This function implements the above_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AboveTspatialStboxLogicalFunction
     */
    AboveTspatialStboxLogicalFunction(
