...
/**
 * @brief MEOS before_tspatial_stbox logical function
 * 
 * This function implements the before_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BeforeTspatialStboxLogicalFunction
     */
    BeforeTspatialStboxLogicalFunction(
