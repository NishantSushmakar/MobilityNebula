...
/**
 * @brief MEOS right_tspatial_stbox logical function
 * 
 * This function implements the right_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for RightTspatialStboxLogicalFunction
     */
