...
/**
 * @brief MEOS adjacent_tspatial_tspatial logical function
 * 
 * This function implements the adjacent_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AdjacentTspatialTspatialLogicalFunction
     */
