...
/**
 * @brief MEOS edwithin_tgeo_tgeo logical function
 * 
 * This function implements the edwithin_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EdwithinTgeoTgeoLogicalFunction
     */
