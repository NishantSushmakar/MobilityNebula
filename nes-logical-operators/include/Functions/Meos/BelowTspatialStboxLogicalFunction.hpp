...
/**
 * @brief MEOS below_tspatial_stbox logical function
 * 
 * This function implements the below_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BelowTspatialStboxLogicalFunction
     */
    BelowTspatialStboxLogicalFunction(
