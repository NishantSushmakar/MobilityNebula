...
/**
 * @brief MEOS overright_stbox_tspatial logical function
 * 
 * This function implements the overright_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverrightStboxTspatialLogicalFunction
     */
    OverrightStboxTspatialLogicalFunction(
