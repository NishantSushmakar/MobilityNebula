...
/**
 * @brief MEOS ever_eq_tgeo_tgeo logical function
 * 
 * This function implements the ever_eq_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EverEqTgeoTgeoLogicalFunction
     */
    EverEqTgeoTgeoLogicalFunction(
