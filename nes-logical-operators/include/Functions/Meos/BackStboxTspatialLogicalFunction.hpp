...
/**
 * @brief MEOS back_stbox_tspatial logical function
 * 
 * This function implements the back_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BackStboxTspatialLogicalFunction
     */
    BackStboxTspatialLogicalFunction(
