...
/**
 * @brief MEOS always_ne_tgeo_geo logical function
 * 
 * This function implements the always_ne_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AlwaysNeTgeoGeoLogicalFunction
     */
    AlwaysNeTgeoGeoLogicalFunction(
