...
/**
 * @brief MEOS overfront_stbox_tspatial logical function
 * 
 * This function implements the overfront_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverfrontStboxTspatialLogicalFunction
     */
