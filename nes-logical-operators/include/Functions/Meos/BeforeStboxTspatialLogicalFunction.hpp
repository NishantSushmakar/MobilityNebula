...
/**
 * @brief MEOS before_stbox_tspatial logical function
 * 
 * This function implements the before_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BeforeStboxTspatialLogicalFunction
     */
