...
/**
 * @brief MEOS before_tspatial_tspatial logical function
 * 
 * This function implements the before_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BeforeTspatialTspatialLogicalFunction
     */
    BeforeTspatialTspatialLogicalFunction(
