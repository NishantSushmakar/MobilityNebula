...
/**
 * @brief MEOS after_tspatial_stbox logical function
 * 
 * This function implements the after_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AfterTspatialStboxLogicalFunction
     */
    AfterTspatialStboxLogicalFunction(
