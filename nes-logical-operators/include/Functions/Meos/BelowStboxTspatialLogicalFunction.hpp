...
/**
 * @brief MEOS below_stbox_tspatial logical function
 * 
 * This function implements the below_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BelowStboxTspatialLogicalFunction
     */
    BelowStboxTspatialLogicalFunction(
