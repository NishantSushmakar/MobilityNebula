...
/**
 * @brief MEOS overleft_tspatial_tspatial logical function
 * 
 * This function implements the overleft_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverleftTspatialTspatialLogicalFunction
     */
