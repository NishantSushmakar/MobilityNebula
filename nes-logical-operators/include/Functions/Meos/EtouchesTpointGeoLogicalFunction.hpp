...
/**
 * @brief MEOS etouches_tpoint_geo logical function
 * 
 * This function implements the etouches_tpoint_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EtouchesTpointGeoLogicalFunction
     */
