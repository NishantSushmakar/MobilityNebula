...
/**
 * @brief MEOS overafter_tspatial_tspatial logical function
 * 
 * This function implements the overafter_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverafterTspatialTspatialLogicalFunction
     */
    OverafterTspatialTspatialLogicalFunction(
