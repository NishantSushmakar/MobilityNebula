...
/**
 * @brief MEOS after_tspatial_tspatial logical function
 * 
 * This function implements the after_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AfterTspatialTspatialLogicalFunction
     */
    AfterTspatialTspatialLogicalFunction(
