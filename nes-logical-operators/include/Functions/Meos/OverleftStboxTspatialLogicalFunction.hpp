...
/**
 * @brief MEOS overleft_stbox_tspatial logical function
 * 
 * This function implements the overleft_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverleftStboxTspatialLogicalFunction
     */
    OverleftStboxTspatialLogicalFunction(
