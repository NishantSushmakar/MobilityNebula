...
/**
 * @brief MEOS adjacent_tspatial_stbox logical function
 * 
 * This function implements the adjacent_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AdjacentTspatialStboxLogicalFunction
     */
