...
/**
 * @brief MEOS below_tspatial_tspatial logical function
 * 
 * This function implements the below_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BelowTspatialTspatialLogicalFunction
     */
    BelowTspatialTspatialLogicalFunction(
