...
/**
 * @brief MEOS tcontains_geo_tgeo logical function
 * 
 * This function implements the tcontains_geo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for TcontainsGeoTgeoLogicalFunction
     */
    TcontainsGeoTgeoLogicalFunction(
