...
/**
 * @brief MEOS overright_tspatial_stbox logical function
 * 
 * This function implements the overright_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverrightTspatialStboxLogicalFunction
     */
