...
/**
 * @brief MEOS front_tspatial_stbox logical function
 * 
 * This function implements the front_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for FrontTspatialStboxLogicalFunction
     */
