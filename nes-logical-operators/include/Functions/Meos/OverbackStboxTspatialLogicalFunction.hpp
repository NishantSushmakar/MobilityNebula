...
/**
 * @brief MEOS overback_stbox_tspatial logical function
 * 
 * This function implements the overback_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbackStboxTspatialLogicalFunction
     */
    OverbackStboxTspatialLogicalFunction(
