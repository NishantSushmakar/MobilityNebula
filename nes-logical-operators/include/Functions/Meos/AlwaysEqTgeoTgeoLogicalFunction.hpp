...
/**
 * @brief MEOS always_eq_tgeo_tgeo logical function
 * 
 * This function implements the always_eq_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AlwaysEqTgeoTgeoLogicalFunction
     */
    AlwaysEqTgeoTgeoLogicalFunction(
