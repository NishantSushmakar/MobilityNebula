...
/**
 * @brief MEOS aintersects_tgeo_tgeo logical function
 * 
 * This function implements the aintersects_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AintersectsTgeoTgeoLogicalFunction
     */
    AintersectsTgeoTgeoLogicalFunction(
