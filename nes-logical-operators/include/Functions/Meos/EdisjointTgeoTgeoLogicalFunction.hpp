...
/**
 * @brief MEOS edisjoint_tgeo_tgeo logical function
 * 
 * This function implements the edisjoint_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EdisjointTgeoTgeoLogicalFunction
     */
    EdisjointTgeoTgeoLogicalFunction(
