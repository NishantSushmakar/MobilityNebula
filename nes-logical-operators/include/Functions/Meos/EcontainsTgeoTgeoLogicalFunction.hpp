...
/**
 * @brief MEOS econtains_tgeo_tgeo logical function
 * 
 * This function implements the econtains_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EcontainsTgeoTgeoLogicalFunction
     */
    EcontainsTgeoTgeoLogicalFunction(
