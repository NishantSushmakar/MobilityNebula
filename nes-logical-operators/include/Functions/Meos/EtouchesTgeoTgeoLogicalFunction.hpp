...
/**
 * @brief MEOS etouches_tgeo_tgeo logical function
 * 
 * This function implements the etouches_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EtouchesTgeoTgeoLogicalFunction
     */
    EtouchesTgeoTgeoLogicalFunction(
