...
/**
 * @brief MEOS overafter_stbox_tspatial logical function
 * 
 * This function implements the overafter_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverafterStboxTspatialLogicalFunction
     */
    OverafterStboxTspatialLogicalFunction(
