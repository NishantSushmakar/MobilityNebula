...
/**
 * @brief MEOS overabove_stbox_tspatial logical function
 * 
 * This function implements the overabove_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OveraboveStboxTspatialLogicalFunction
     */
    OveraboveStboxTspatialLogicalFunction(
