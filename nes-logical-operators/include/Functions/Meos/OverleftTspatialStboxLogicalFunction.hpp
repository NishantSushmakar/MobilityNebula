...
/**
 * @brief MEOS overleft_tspatial_stbox logical function
 * 
 * This function implements the overleft_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverleftTspatialStboxLogicalFunction
     */
