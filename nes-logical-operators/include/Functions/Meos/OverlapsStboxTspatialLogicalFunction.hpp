...
/**
 * @brief MEOS overlaps_stbox_tspatial logical function
 * 
 * This function implements the overlaps_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverlapsStboxTspatialLogicalFunction
     */
