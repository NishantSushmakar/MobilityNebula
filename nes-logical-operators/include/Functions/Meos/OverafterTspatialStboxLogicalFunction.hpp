...
/**
 * @brief MEOS overafter_tspatial_stbox logical function
 * 
 * This function implements the overafter_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverafterTspatialStboxLogicalFunction
     */
