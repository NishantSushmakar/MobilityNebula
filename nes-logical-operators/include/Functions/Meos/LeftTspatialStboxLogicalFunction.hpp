...
/**
 * @brief MEOS left_tspatial_stbox logical function
 * 
 * This function implements the left_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for LeftTspatialStboxLogicalFunction
     */
    LeftTspatialStboxLogicalFunction(
