...
/**
 * @brief MEOS overfront_tspatial_stbox logical function
 * 
 * This function implements the overfront_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverfrontTspatialStboxLogicalFunction
     */
    OverfrontTspatialStboxLogicalFunction(
