...
/**
 * @brief MEOS edwithin_tgeo_geo logical function
 * 
 * This function implements the edwithin_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EdwithinTgeoGeoLogicalFunction
     */
