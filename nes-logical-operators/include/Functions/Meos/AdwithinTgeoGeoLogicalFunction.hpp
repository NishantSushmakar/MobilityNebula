...
/**
 * @brief MEOS adwithin_tgeo_geo logical function
 * 
 * This function implements the adwithin_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AdwithinTgeoGeoLogicalFunction
     */
