...
/**
 * @brief MEOS back_tspatial_tspatial logical function
 * 
 * This function implements the back_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for BackTspatialTspatialLogicalFunction
     */
    BackTspatialTspatialLogicalFunction(
