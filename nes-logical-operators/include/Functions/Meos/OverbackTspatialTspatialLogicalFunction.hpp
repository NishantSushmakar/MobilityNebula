...
/**
 * @brief MEOS overback_tspatial_tspatial logical function
 * 
 * This function implements the overback_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbackTspatialTspatialLogicalFunction
     */
    OverbackTspatialTspatialLogicalFunction(
