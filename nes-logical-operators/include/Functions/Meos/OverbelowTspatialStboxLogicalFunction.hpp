...
/**
 * @brief MEOS overbelow_tspatial_stbox logical function
 * 
 * This function implements the overbelow_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for OverbelowTspatialStboxLogicalFunction
     */
    OverbelowTspatialStboxLogicalFunction(
