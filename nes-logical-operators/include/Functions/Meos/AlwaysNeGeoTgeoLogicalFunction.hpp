...
/**
 * @brief MEOS always_ne_geo_tgeo logical function
 * 
 * This function implements the always_ne_geo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AlwaysNeGeoTgeoLogicalFunction
     */
    AlwaysNeGeoTgeoLogicalFunction(
