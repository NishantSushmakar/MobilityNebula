...
/**
 * @brief MEOS contained_tspatial_stbox logical function
 * 
 * This function implements the contained_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for ContainedTspatialStboxLogicalFunction
     */
    ContainedTspatialStboxLogicalFunction(
