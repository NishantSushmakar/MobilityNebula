...
/**
 * @brief MEOS etouches_tgeo_geo logical function
 * 
 * This function implements the etouches_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EtouchesTgeoGeoLogicalFunction
     */
    EtouchesTgeoGeoLogicalFunction(
