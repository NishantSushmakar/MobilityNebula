...
/**
 * @brief MEOS aintersects_tgeo_geo logical function
 * 
 * This function implements the aintersects_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AintersectsTgeoGeoLogicalFunction
     */
    AintersectsTgeoGeoLogicalFunction(
