...
/**
 * @brief MEOS adjacent_stbox_tspatial logical function
 * 
 * This function implements the adjacent_stbox_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AdjacentStboxTspatialLogicalFunction
     */
    AdjacentStboxTspatialLogicalFunction(
