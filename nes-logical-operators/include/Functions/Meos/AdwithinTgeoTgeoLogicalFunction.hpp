...
/**
 * @brief MEOS adwithin_tgeo_tgeo logical function
 * 
 * This function implements the adwithin_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AdwithinTgeoTgeoLogicalFunction
     */
    AdwithinTgeoTgeoLogicalFunction(
