...
/**
 * @brief MEOS ecovers_geo_tgeo logical function
 * 
 * This function implements the ecovers_geo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EcoversGeoTgeoLogicalFunction
     */
    EcoversGeoTgeoLogicalFunction(
