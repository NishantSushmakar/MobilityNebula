...
/**
 * @brief MEOS edisjoint_tgeo_geo logical function
 * 
 * This function implements the edisjoint_tgeo_geo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EdisjointTgeoGeoLogicalFunction
     */
