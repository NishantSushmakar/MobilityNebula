...
/**
 * @brief MEOS front_tspatial_tspatial logical function
 * 
 * This function implements the front_tspatial_tspatial operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for FrontTspatialTspatialLogicalFunction
     */
