...
/**
 * @brief MEOS same_tspatial_stbox logical function
 * 
 * This function implements the same_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for SameTspatialStboxLogicalFunction
     */
    SameTspatialStboxLogicalFunction(
