...
/**
 * @brief MEOS ever_ne_tgeo_tgeo logical function
 * 
 * This function implements the ever_ne_tgeo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for EverNeTgeoTgeoLogicalFunction
     */
    EverNeTgeoTgeoLogicalFunction(
