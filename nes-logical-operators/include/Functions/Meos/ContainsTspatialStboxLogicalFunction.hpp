...
/**
 * @brief MEOS contains_tspatial_stbox logical function
 * 
 * This function implements the contains_tspatial_stbox operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for ContainsTspatialStboxLogicalFunction
     */
    ContainsTspatialStboxLogicalFunction(
