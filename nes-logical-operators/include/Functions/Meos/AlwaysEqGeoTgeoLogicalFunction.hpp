...
/**
 * @brief MEOS always_eq_geo_tgeo logical function
 * 
 * This function implements the always_eq_geo_tgeo operation from MEOS library.
...
public:
    ...
    /**
     * @brief Constructor for AlwaysEqGeoTgeoLogicalFunction
     */
    AlwaysEqGeoTgeoLogicalFunction(
