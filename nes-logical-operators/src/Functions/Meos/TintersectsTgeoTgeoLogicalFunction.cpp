...
TintersectsTgeoTgeoLogicalFunction::TintersectsTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction timestamp1, LogicalFunction staticGeometry)
...
TintersectsTgeoTgeoLogicalFunction::TintersectsTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction timestamp1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction timestamp2)
    : dataType(DataTypeProvider::provideDataType(DataType::Type::INT32))
...
LogicalFunction TintersectsTgeoTgeoLogicalFunction::withDataType(const DataType& dataType) const
{
    auto copy = *this;
...
{
    PRECONDITION(children.size() == 4 || children.size() == 6, "TintersectsTgeoTgeoLogicalFunction requires 4 or 6 children, but got {}", children.size());
    auto copy = *this;
...
std::string TintersectsTgeoTgeoLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    ...
    return fmt::format("TEMPORAL_TINTERSECTS_TGEO_TGEO_GEOMETRY({})", args);
}
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterTintersectsTgeoTgeoLogicalFunction(LogicalFunctionRegistryArguments arguments)
{
    if (arguments.children.size() == 4) {
        return TintersectsTgeoTgeoLogicalFunction(arguments.children[0], arguments.children[1], arguments.children[2], arguments.children[3]);
    } else if (arguments.children.size() == 6) {
        return TintersectsTgeoTgeoLogicalFunction(arguments.children[0], arguments.children[1], arguments.children[2], arguments.children[3], arguments.children[4], arguments.children[5]);
    } else {
        PRECONDITION(false, "TintersectsTgeoTgeoLogicalFunction requires 4 or 6 children, but got {}", arguments.children.size());
    }
}
