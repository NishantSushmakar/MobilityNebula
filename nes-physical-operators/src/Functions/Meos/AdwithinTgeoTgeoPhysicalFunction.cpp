...
AdwithinTgeoTgeoPhysicalFunction::AdwithinTgeoTgeoPhysicalFunction(        PhysicalFunction param0Function,
    ...
    const auto result = nautilus::invoke(
        +[](const char* param0_ptr, uint32_t param0_size, const char* param1_ptr, uint32_t param1_size, double param2) -> int32_t {
            try {
                ...
                auto meos_result = MEOS::adwithin_tgeo_tgeo(param0_obj, param1_obj, param2);
...
PhysicalFunctionGeneratedRegistrar::RegisterAdwithinTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments physicalFunctionRegistryArguments)
{
    PRECONDITION(physicalFunctionRegistryArguments.childFunctions.size() == 3, "AdwithinTgeoTgeoPhysicalFunction requires exactly 3 child functions, but got {}", physicalFunctionRegistryArguments.childFunctions.size());
    return AdwithinTgeoTgeoPhysicalFunction(physicalFunctionRegistryArguments.childFunctions[0], physicalFunctionRegistryArguments.childFunctions[1], physicalFunctionRegistryArguments.childFunctions[2]);
}
