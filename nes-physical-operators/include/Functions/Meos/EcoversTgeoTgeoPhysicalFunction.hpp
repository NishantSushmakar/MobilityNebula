...
/**
 * @brief Physical function for MEOS ecovers_tgeo_tgeo operation
 * 
 * This function executes the meos spatial relationship using MEOS ecovers_tgeo_tgeo
 * using the MEOS library function ecovers_tgeo_tgeo.
 * 
...
public:
    /**
     * @brief Constructor for ecovers_tgeo_tgeo physical function
     * @param param0 const Temporal * parameter
     * @param param1 const Temporal * parameter

     */
    EcoversTgeoTgeoPhysicalFunction(        PhysicalFunction param0Function,
