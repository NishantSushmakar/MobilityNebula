...
/**
 * @brief Physical function for MEOS edwithin_tgeo_geo operation
 * 
 * This function executes the meos spatial relationship using MEOS edwithin_tgeo_geo
 * using the MEOS library function edwithin_tgeo_geo.
 * 
 * Function signature: extern int edwithin_tgeo_geo(const Temporal *temp, const GSERIALIZED *gs, double dist);
 */
class EdwithinTgeoGeoPhysicalFunction : public PhysicalFunctionConcept {
public:
    /**
     * @brief Constructor for edwithin_tgeo_geo physical function
     * @param param0 const Temporal * parameter
     * @param param1 const GSERIALIZED * parameter
     * @param param2 double parameter

     */
    EdwithinTgeoGeoPhysicalFunction(        PhysicalFunction param0Function,
