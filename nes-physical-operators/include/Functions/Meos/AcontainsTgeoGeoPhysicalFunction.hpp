...
/**
 * @brief Physical function for MEOS acontains_tgeo_geo operation
 * 
 * This function executes the meos spatial relationship using MEOS acontains_tgeo_geo
 * using the MEOS library function acontains_tgeo_geo.
 * 
...
public:
    /**
     * @brief Constructor for acontains_tgeo_geo physical function
     * @param param0 const Temporal * parameter
     * @param param1 const GSERIALIZED * parameter

     */
    AcontainsTgeoGeoPhysicalFunction(        PhysicalFunction param0Function,
